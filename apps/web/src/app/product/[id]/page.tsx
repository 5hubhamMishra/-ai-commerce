            ...
            <div className="mt-3 flex gap-2">
              {product.images.map((img, i) => (
                <div
                  ...
                  className={`relative h-16 w-16 rounded-xl overflow-hidden cursor-pointer ring-2 transition-all ${
                    activeImage === i
                      ? "ring-[var(--clr-accent)]"
        ...
        <div>
          ...
          <div className="mt-6 flex gap-3">
            <div className="flex items-center rounded-xl border" style={{ borderColor: 'var(--clr-border)' }}>
              <button onClick={() => setQty((q) => Math.max(1, q - 1))} className="px-3 py-2.5 text-lg font-medium hover:bg-stone-50 transition-colors" style={{ color: 'var(--clr-text-secondary)' }}>
                −
              </button>
              <span className="w-10 text-center text-sm font-semibold" style={{ color: 'var(--clr-text-primary)' }}>{qty}</span>
              <button onClick={() => setQty((q) => q + 1)} className="px-3 py-2.5 text-lg font-medium hover:bg-stone-50 transition-colors" style={{ color: 'var(--clr-text-secondary)' }}>
                +
              </button>
            </div>
            <button
